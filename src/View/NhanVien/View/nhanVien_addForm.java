 ...
 * @author hnhut
 */
public class nhanVien_addForm extends javax.swing.JFrame {

    /**
     * Creates new form nhanVien_addForm
     */
    public nhanVien_addForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nhanVien_addForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new nhanVien_addForm().setVisible(true);
            }
        });
    }
